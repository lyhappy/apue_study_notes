...
#endif
#ifdef MAX_CANON
	printf("MAX_CANON defined to bo %d\n", MAX_CANON+0);
#else
...
#endif
#ifdef MAX_INPUT
	printf("MAX_INPUT defined to bo %d\n", MAX_INPUT+0);
#else
...
#endif
#ifdef FILESIZEBITS
	printf("FILESIZEBITS defined to bo %d\n", FILESIZEBITS+0);
#else
...
#endif
#ifdef LINK_MAX
	printf("LINK_MAX defined to bo %d\n", LINK_MAX+0);
#else
...
#endif
#ifdef NAME_MAX
	printf("NAME_MAX defined to bo %d\n", NAME_MAX+0);
#else
...
#endif
#ifdef PATH_MAX
	printf("PATH_MAX defined to bo %d\n", PATH_MAX+0);
#else
...
#endif
#ifdef PIPE_BUF
	printf("PIPE_BUF defined to bo %d\n", PIPE_BUF+0);
#else
...
#endif
#ifdef SYMLINK_MAX
	printf("SYMLINK_MAX defined to bo %d\n", SYMLINK_MAX+0);
#else
